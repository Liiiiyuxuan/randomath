...
\begin{solution}
    Suppose for a contradiction that $L$ is a regular language, thus there exists pumping lengh $p$ such that satisfies the pumping lemma. Now consider the string 
    \[ \omega := 0^p 1^p \in L \]
